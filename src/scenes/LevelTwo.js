class LevelTwo extends Phaser.Scene {
    ...
    create() {
        ...
        this.thug1 = new Thug(this, 450, 175, 'thug', 0, 'left').setScale(2.1).setOrigin(0.5).setSize(20, 20)
        this.thug2 = new Thug(this, 475, 250, 'thug', 0, 'left').setScale(2.1).setOrigin(0.5).setSize(20, 20)

        this.hammer = new Hammer(this, 700, 200, 'hammer', 0, 'left').setScale(3).setOrigin(0.5).setSize(20, 20)

        this.thugs = this.add.group([this.thug1, this.thug2])

        //add chairs
        this.chair1 = this.physics.add.sprite(150, 150, 'chair').setScale(3).setSize(10, 10)
        this.chair1.body.setImmovable(true)

        this.chair2 = this.physics.add.sprite(275, 125, 'chair').setScale(3).setSize(10, 10)
        this.chair2.body.setImmovable(true)

        this.chair3 = this.physics.add.sprite(500, 150, 'chair').setScale(3).setSize(10, 10)
        this.chair3.body.setImmovable(true)

        this.chairs = this.add.group([this.chair1, this.chair2, this.chair3])
        this.chairGrab
    ...
    gameWinScreen() {
        ...
        this.overlay = this.add.rectangle(400, 300, 800, 600, 0x000000, 0.3)
        this.pauseText = this.add.bitmapText(this.cameras.main.scrollX + 200, this.cameras.main.scrollY + 100, 'jersey', 'YOU WIN!', 90).setOrigin(0.5, 0.5)
        this.menuButton = this.add.image(this.cameras.main.scrollX + 200, this.cameras.main.scrollY + 220, 'menu-button').setOrigin(0.5, 0.5).setScale(0.2).setInteractive().on('pointerdown', () => {
            //this.sound.play('select')
            this.scene.start('menuScene')
        }).on('pointerover', () => this.menuButton.setTint(0xaaaaaa)).on('pointerout', () => this.menuButton.clearTint())
